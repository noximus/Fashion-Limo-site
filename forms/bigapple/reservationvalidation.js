...
function validateinfo() 
{
	...
	if (!nameIsGood(document.reservation.nameOnCard))
	{
		alert("Please enter a valid Name for your credit card number.  It should not have numbers or extended characters.\n");
		document.reservation.nameOnCard.focus();
		return false;
	}	

	if (document.reservation.paymentType.value == "")
	{
		alert("Please select a Payment Type.\n");
		document.reservation.paymentType.focus();
		return false;
	}		
	
	if(!isNumber(document.reservation.creditCardNumber.value))
	{
		alert("The Credit Card Number should be numeric.  NO spaces or dashes.\n");
		document.reservation.creditCardNumber.focus();
		return false;
	}
	
	if (document.reservation.expireMonth.value == "")
	{
		alert("Please select the credit card's Month of Expiration.\n");
		document.reservation.expireMonth.focus();
		return false;
	}

	if (document.reservation.expireYear.value == "")
	{
		alert("Please select the credit card's Year of Expiration.\n");
		document.reservation.expireYear.focus();
		return false;
	}
	...
	if (document.reservation.airportSelection.value == "")
	{
		alert("Please select the Airport and Flight information.\n");
		document.reservation.airportSelection.focus();
		return false;
	}
